...
const getStyles = (isDark: boolean): { [key: string]: React.CSSProperties } => ({
    ...
    moodText: { ...typography.body, fontSize: 14, fontWeight: '600', color: isDark ? colors.light : colors.dark },
    ...
    symptomSubheader: { ...typography.body, fontWeight: '500', color: isDark ? colors.gray[300] : colors.slate[600], margin: 0 },
    ...
    addButtonText: { color: colors.light, fontWeight: '600' },
    ...
    saveButtonText: { color: colors.light, fontWeight: '600', fontSize: 16 },
    ...
    checkmark: { color: colors.light, fontWeight: 'bold', fontSize: 16 },
    periodText: { ...typography.body, fontSize: 15, fontWeight: '500', color: isDark ? colors.light : colors.dark },
